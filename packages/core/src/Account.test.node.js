...
const {AuthAPI} = require('@wireapp/api-client/dist/auth/');
const {BackendErrorLabel, StatusCode} = require('@wireapp/api-client/dist/http/');
const {ClientAPI, ClientType} = require('@wireapp/api-client/dist/client/');
const {ConversationAPI} = require('@wireapp/api-client/dist/conversation/');
const {GenericMessage, Text} = require('@wireapp/protocol-messaging');
const {MemoryEngine} = require('@wireapp/store-engine');
const {NotificationAPI} = require('@wireapp/api-client/dist/notification/');
const {ValidationUtil} = require('@wireapp/commons');
const {WebSocketTopic} = require('@wireapp/api-client/dist/tcp/');
