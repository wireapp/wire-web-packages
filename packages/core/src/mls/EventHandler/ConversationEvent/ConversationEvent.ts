...
interface HandlWelcomeMessageParams extends EventHandlerParams {
  event: ConversationMLSWelcomeEvent;
}
const handleWelcomeMessage = async ({mlsService, event, source}: HandlWelcomeMessageParams): EventHandlerResult => {
