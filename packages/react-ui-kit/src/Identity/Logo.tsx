...
const logoStyles: (props: LogoProps) => ObjectInterpolation<undefined> = ({hover, color = COLOR.GRAY_DARKEN_48}) => ({
  '&:hover path': {
...
const Logo = ({hover, ...props}: LogoProps) => (
  <SVGIcon realWidth={57} realHeight={18} css={logoStyles({hover, ...props})} {...props}>
