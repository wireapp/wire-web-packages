...
export const H1 = (props: HeadingProps) => <h1 css={(theme: Theme) => h1Style(theme, props)} {...filterTextProps(props)} />;
...
export const H2 = (props: HeadingProps) => <h2 css={(theme: Theme) => h2Style(theme, props)} {...filterTextProps(props)} />;
...
export const H3 = (props: HeadingProps) => <h3 css={(theme: Theme) => h3Style(theme, props)} {...filterTextProps(props)} />;
...
export const H4 = (props: HeadingProps) => <h3 css={(theme: Theme) => h4Style(theme, props)} {...filterTextProps(props)} />;
